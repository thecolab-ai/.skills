...
11. Treat Christchurch recreation as discovered but not fully wired in v1; the public council page is protected/vendor-backed.
...
python3 skills/nz-council/scripts/cli.py pools [--council akl|wlg|chc|rot|npl|npr|has|ham] [--region central|east|north|south|west] [--limit N] [--json]
python3 skills/nz-council/scripts/cli.py pool <name> [--council akl|wlg|chc|rot|npl|npr|has|ham] [--json]
python3 skills/nz-council/scripts/cli.py facilities [--council akl|wlg|chc|rot|npl|npr|has|ham] [--type pool|gym|leisure-centre|library] [--region central|east|north|south|west] [--limit N] [--json]
```
