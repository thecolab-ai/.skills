...
metadata:
  ...
  thecolab.public_commands: "search,listing,regions,categories"
  thecolab.public_description: "Search and inspect public Trade Me NZ listings, regions, and categories without signing in."
  thecolab.public_access_mode: "public-api"
  thecolab.public_health: "healthy"
  thecolab.public_risk: "medium"
  thecolab.public_allowed_domains: "api.trademe.co.nz,www.trademe.co.nz"
