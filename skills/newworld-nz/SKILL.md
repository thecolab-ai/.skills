...
metadata:
  ...
  thecolab.public_description: "Query New World NZ stores, categories, products, specials, and store-specific guest prices without an account."
  thecolab.public_access_mode: "public-api"
  thecolab.public_health: "healthy"
  thecolab.public_risk: "medium"
  thecolab.public_allowed_domains: "api-prod.clubplus.co.nz,api-prod.newworld.co.nz,www.newworld.co.nz"
