...
def test_auth_helpers_fixture():
    ...
    spec = importlib.util.spec_from_file_location("newworld_nz_auth_cli", CLI)
    assert spec and spec.loader
    module = importlib.util.module_from_spec(spec)
    sys.modules[spec.name] = module
    spec.loader.exec_module(module)
...
def test_list_mutation_contract():
    ...
    spec = importlib.util.spec_from_file_location("newworld_nz_list_cli", CLI)
    assert spec and spec.loader
    module = importlib.util.module_from_spec(spec)
    sys.modules[spec.name] = module
    spec.loader.exec_module(module)
...
def test_cart_mutation_contract():
    ...
    spec = importlib.util.spec_from_file_location("newworld_nz_cart_cli", CLI)
    assert spec and spec.loader
    module = importlib.util.module_from_spec(spec)
    sys.modules[spec.name] = module
    spec.loader.exec_module(module)
